...
const char *WARC::getHtmlHomePage()
{
  const char *htmlHomePage = R"HTMLHOMEPAGE(
        ...
        <body class="noselect" align="center" style="background-color:white">
            <h1 style="color: teal;text-align:center;">Dashboard &#128241; Web Controller</h1>
            ...
            <div class="container">
                ...
                <tr>
                    <td ontouchstart='onTouchStartAndEnd("__")' ontouchend='onTouchStartAndEnd("__")'><span class="arrows">&#127925;</span></td>
                </tr>
                <tr>
